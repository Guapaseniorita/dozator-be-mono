...
@Component
class Month15VaccineCalendarResultFactory: VaccineCalendarResultFactory() {

    override val type: VaccineCalendarResultType = VaccineCalendarResultType.MONTH_15

    override fun getDescription(vararg doseArgument: DoseArgument): Description =
        Description("Какие вакцины нужно сделать на пятнадцатом месяце жизни:")
            ...
            .add(caption = "Следующая вакцинация", description = "в 18 месяцев:")
