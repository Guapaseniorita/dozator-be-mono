...
@Component
class Month20VaccineCalendarResultFactory: VaccineCalendarResultFactory() {

    override val type: VaccineCalendarResultType = VaccineCalendarResultType.MONTH_20
    ...
    override fun getDescription(vararg doseArgument: DoseArgument): Description =
        Description("Какие вакцины нужно сделать:")
            ...
            .add("6. Три вакцинации против полиомиелита и первая ревакцинация против полиомиелита.")
            ...
            .add(caption = "Следующая вакцинация", description = "в 6 лет:")
